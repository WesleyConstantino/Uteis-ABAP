...
DATA: it_ztaula_curso     TYPE TABLE OF ztaula_curso,
      lt_zaula_curso_negr TYPE TABLE OF ty_zaula_curso,
...
CLASS lcl_event_grid IMPLEMENTATION.
  ...
  METHOD data_changed.
    LOOP AT er_data_changed->mt_good_cells[] ASSIGNING FIELD-SYMBOL(<fs_good_cells>).
      READ TABLE it_ztaula_curs_alun[] ASSIGNING FIELD-SYMBOL(<fs_zaula_curso_alun>) INDEX <fs_good_cells>-row_id.
...
MODULE m_show_grid_100 OUTPUT.
  ...
  ls_layout-stylefname = 'CELLTAB'. "Texto em Negrit
