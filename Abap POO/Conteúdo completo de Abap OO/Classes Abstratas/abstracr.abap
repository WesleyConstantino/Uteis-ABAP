...
"São classes que servem como base para outras classes, não podem ser instanciadas, são classes incompletas.
*OBS: não é possível criar um objeto de uma classe abstrata.
